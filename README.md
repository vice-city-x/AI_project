...
### Flask
- 로그인 및 회원가입 기능
- 이미지 업로드 하면 감정 예측 및 랜덤 피드백 코멘트 출력
- 감정 분석 내역 확인 가능
- DB 기반 감정 분석 통계 대시보드
- DB 기반 관리자 페이지로 관리자는 관리자 페이지에서 데이터 조회 및 수정, 삭제 등 데이터 관리 가능
- ngrok으로 어디서든 접속 가능한 링크 생성 가능

### 플라스크 시연 영상

![455270033-7a5a066f-9aa8-46c8-84a0-f2a2f5c43d6f](https://github.com/user-attachments/assets/10622618-36bd-4cfb-93cf-2f10cc0f4bab)

![455270039-9f248cf9-2394-4f63-9bfd-4fa720d868b6](https://github.com/user-attachments/assets/14188b39-2497-4400-8001-630140276f09)
